        ...
        <>
            ...
            <div className="container mt-custom box-shadow bg-white">
                ...
                <div className="item-card">
                                            <span className="title" >procedura</span>
                                            <div className="img"></div>
                                            <span className="price" >1$</span>
                                            <span className="rating"><svg height="10px" width="10px" version="1.1" id="Capa_1"
...
</svg><svg height="10px" width="10px" version="1.1" id="Capa_1"
	 viewBox="0 0 47.94 47.94">
<path  d="M26.285,2.486l5.407,10.956c0.376,0.762,1.103,1.29,1.944,1.412l12.091,1.757
	c2.118,0.308,2.963,2.91,1.431,4.403l-8.749,8.528c-0.608,0.593-0.886,1.448-0.742,2.285l2.065,12.042
	c0.362,2.109-1.852,3.717-3.746,2.722l-10.814-5.685c-0.752-0.395-1.651-0.395-2.403,0l-10.814,5.685
                ...
                <div className="row">
                    <div className="container">
                        <div className="col-11 col-md-11 bg-white third_section container">
                            <div className="row">
                                <div className="col-12 ss_header"></div>
                            </div>
                        </div>
                    </div>
                </div>
